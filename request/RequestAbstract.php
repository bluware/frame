...
{
    /**
     *  @var \Blu\Request\Query
     */
    protected $query;

    /**
     *  @var \Blu\Request\Body
     */
    protected $body;

    /**
     *  @var \Blu\Request\Files
     */
    protected $files;

    /**
     *  @var \Blu\Request\Cookies
     */
    protected $cookies;

    /**
     *  @var \Blu\Request\Server
     */
    protected $server;
    ...
    public function __construct(
        ...
        /**
         *  @param \Blu\Request\Query
         */
        $this->query = new \Blu\Request\Query(
            $query !== null ? $query : $_GET
        );

        /**
         *  @param \Blu\Request\Files
         */
        $this->files = new \Blu\Request\Files(
            $files !== null ? $files : $_FILES
        );

        /**
         *  @param \Blu\Request\Cookie
         */
        $this->cookies = new \Blu\Request\Cookies(
         ...
         *  @param \Blu\Request\Cookie
         */
        $this->server = new \Blu\Request\Server(
            array_replace(
                [
         ...
         */
        $this->body = new \Blu\Request\Body(
